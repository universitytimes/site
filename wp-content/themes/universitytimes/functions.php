...
<table id="listofposts" style="font-size: 15px; width: 60%;">
...
<input class="button" name="updatepostorder" id="updatepostorder" type="submit" value="Update Post Order" style="margin-top: 8px;"/>

<input class="button" name="clearpostorder" id="clearpostorder" type="submit" value="Clear Post Order" style="margin-top: 8px;"/>
...
<div id="STUFFTOPRINT">
 ...
 jQuery('#postlist').on('submit', function (e) {
   ...
   jQuery.ajax({
        ...
        form: jQuery('#postlist').serialize(),
